...
#         stframe2 = st.empty() # Placeholder for background subtracted frame
...
#             countours, _ = cv2.findContours(fg_mask, 
#                                             cv2.RETR_EXTERNAL,
...
#             stframe.image(convert_img(frame), channels="RGB")
#             stframe2.image(convert_img(fg_mask), channels="RGB")
#             time.sleep(0.001)
#         captures.release()
